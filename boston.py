...
def explore_city_data(city_data):
    ...
    housing_features = city_data["RM, LSTAT, PTRATIO, INDUS, NOX, CRIM, ZN, DIS, CHAS".split(", ")]
...
def fit_predict_model(city_data):
    ...
    # http://scikit-learn.org/stable/modules/generated/sklear.GridSearchCV.html#sklear.GridSearchCV
...
def main():
    ...
    # Load data
    city_data = pd.read_csv('boston_housing.csv')
